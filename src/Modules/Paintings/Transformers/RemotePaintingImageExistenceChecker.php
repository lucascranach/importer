...
class RemotePaintingImageExistenceChecker extends Hybrid
{
    ...
    private $cacheFilename = 'remotePaintingImageExistenceChecker';
    ...
    private function getPreparedImageType($stackItem, $inventoryNumber, $imageType)
    {
        ...
        /* TODO: paintings currently only have one variant,
            so the 'images'-field is an object and not an array with various objects
                -> update on change */
