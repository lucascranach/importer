...
class ExtenderWithBasicFilterValues extends Hybrid
{
    ...
    public function done(IProducer $producer)
    {
        ...
        echo "== Drawing objects with missing filter connections: \n";
    ...
    private function extendCollectionWithBasicFilterValues(SearchableDrawingLanguageCollection $collection): void
    {
        /** @var ISearchableDrawing $item */
