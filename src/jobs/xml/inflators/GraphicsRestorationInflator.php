...
require_once 'entities/graphicRestoration/Survey.php';
require_once 'entities/graphicRestoration/Test.php';
require_once 'entities/graphicRestoration/Person.php';
require_once 'entities/graphicRestoration/ProcessingDates.php';
require_once 'entities/graphicRestoration/Signature.php';


use CranachImport\Entities\GraphicRestoration;

use CranachImport\Entities\GraphicRestoration\Survey;
use CranachImport\Entities\GraphicRestoration\Test;
use CranachImport\Entities\GraphicRestoration\Person;
use CranachImport\Entities\GraphicRestoration\ProcessingDates;
use CranachImport\Entities\GraphicRestoration\Signature;
...
class GraphicsRestorationInflator implements IGraphicRestorationInflator {
	...
	/* Object Id */
	private static function inflateObjectId(\SimpleXMLElement &$node,
	                                        GraphicRestoration &$graphicRestoration) {
	...
	/* Surveys */
	private static function inflateSurveys(\SimpleXMLElement &$nodes,
	                                       GraphicRestoration &$graphicRestoration) {
	...
	/* Survey */
	private static function inflateSurvey(\SimpleXMLElement &$node,
	                                      GraphicRestoration &$graphicRestoration) {
		$survey = new Survey;
	...
	/* Survey Tests */
	private static function inflateSurveyTests(\SimpleXMLElement &$node,
	...
	/* Survey Persons */
	private static function inflateSurveyPersons(\SimpleXMLElement &$node,
	                                             Survey &$restorationSurvey) {
	...
	private static function inflateSurveyProcessingDates(\SimpleXMLElement &$node,
	                                                     Survey &$survey) {
	...
	/* Survey Signature */
	private static function inflateSurveySignature(\SimpleXMLElement &$node,
	                                               Survey &$survey) {
