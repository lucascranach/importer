...
require_once 'modules/graphics/entities/Classification.php';

require_once 'modules/main/entities/Person.php';
require_once 'modules/main/entities/PersonName.php';
require_once 'modules/main/entities/PersonNameDetail.php';
require_once 'modules/main/entities/Title.php';
require_once 'modules/main/entities/Dating.php';
require_once 'modules/main/entities/HistoricEventInformation.php';
require_once 'modules/main/entities/ObjectReference.php';
require_once 'modules/main/entities/AdditionalTextInformation.php';
require_once 'modules/main/entities/Publication.php';
require_once 'modules/main/entities/MetaReference.php';
require_once 'modules/main/entities/CatalogWorkReference.php';
require_once 'modules/main/entities/StructuredDimension.php';


use CranachImport\Modules\Graphics\Entities\Graphic;
use CranachImport\Modules\Graphics\Entities\Classification;

use CranachImport\Modules\Main\Entities\Person;
use CranachImport\Modules\Main\Entities\PersonName;
use CranachImport\Modules\Main\Entities\PersonNameDetail;
use CranachImport\Modules\Main\Entities\Title;
use CranachImport\Modules\Main\Entities\Dating;
use CranachImport\Modules\Main\Entities\HistoricEventInformation;
use CranachImport\Modules\Main\Entities\ObjectReference;
use CranachImport\Modules\Main\Entities\AdditionalTextInformation;
use CranachImport\Modules\Main\Entities\Publication;
use CranachImport\Modules\Main\Entities\MetaReference;
use CranachImport\Modules\Main\Entities\CatalogWorkReference;
use CranachImport\Modules\Main\Entities\StructuredDimension;
